...
def fetch_sources(cve_id: str) -> dict:
    return {
        "circl": fetch_json(CIRCL_URL_TEMPLATE.format(cve_id=cve_id)),
        "nvd": fetch_json(NVD_URL_TEMPLATE.format(cve_id=cve_id)),
        "osv": fetch_json(OSV_URL_TEMPLATE.format(cve_id=cve_id)),
        "cveorg": fetch_json(CVEORG_URL_TEMPLATE.format(cve_id=cve_id)),
    }
